...
const SIDE_PROJECT = [
  {
    ...
    description:
      "Site web pour un café, pour apprendre le développement web en front-end",
  ...
  },
  {
    ...
    description: "Application pour apprendre API et Java Script.",
    url: "https://b-image1.vercel.app/",
  },

  {
    Logo: Workflow,
    title: "projet 5 : Authentification",
    description:
      "Application pour apprendre API et Java Script projet en cours 65%.",
    url: "https://www.youtube.com/watch?v=bicCg4GxOP8",
  },
];
      ...
      <div className="flex-[3] w-full">
        <Card className="w-full p-4 flex flex-col gap-2 w-full">
          <p className="text-lg text-muted-foreground">
            Projet parallèle pour apprendre
          </p>
